...
public class WatchList extends ListActivity{
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		if(item_type[position].equalsIgnoreCase("auction")){
			Intent iAuction = new Intent(WatchList.this,Auction.class);
			iAuction.putExtra("ITEM_ID", item_id[position].toString());
			startActivity(iAuction);
		}
		else{
			Intent iItem = new Intent(WatchList.this,Item.class);
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setTextFilterEnabled(true);
         ...
         try{
             ...
             httppost= new HttpPost(getString(R.string.SERVER_IP)+"viewlist.php"); // make sure the url is correct.
             //add your data
             ...
             runOnUiThread(new Runnable() {
                    public void run() {
						...
						try {
							...
							setListAdapter(new ArrayAdapter<String>(WatchList.this, android.R.layout.simple_list_item_1, item_nm));
						} catch (JSONException e) {
							// TODO Auto-generated catch block
							e.printStackTrace();
							Toast.makeText(WatchList.this, "JSON exception.", Toast.LENGTH_SHORT).show();
						}
                     }
             	});
         }catch(Exception e){
